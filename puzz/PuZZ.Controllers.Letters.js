...
// ==============================================================
//
// PuZZGame.StateControllers.LettersController
//
// ==============================================================
PuZZGame.StateControllers.LettersController = function(){
  ...
  var _locations = {
    ...
    values       : [ ['a','e','i'], ['o','u','a'],['A','E','I'], ['O','U','A'],
                     ['a','b','c'], ['d','e','f'], 
  ...
  function __onSuccess(target){
    ...
    var __e = Pol.Core.Game.EventManager.buildEvent( function(){         
        ...
        target.visible = true;
        if(__last){
          _dialog = PuZZGame.Dialogs.AnimalPicker;
          _dialog.Activate(0, function(){
            _dialog = undefined;
            __initNumbers(_TOTAL_COUNT);  
          });                                                                  
        }        
