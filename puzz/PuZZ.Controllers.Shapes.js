...
// ==============================================================
//
// PuZZGame.StateControllers.ShapesController
//
// ==============================================================
PuZZGame.StateControllers.ShapesController = function(){
...
var _states = Pol.Core.StateManager();  
  ...
  var _dragItem;
  var _locations = {
    positions    : [ new Pol.Core.Math.Vector2(906,392),
                     new Pol.Core.Math.Vector2(508,381),
                     new Pol.Core.Math.Vector2(46,360)
                   ],
    destinations : [ new Pol.Core.Math.Vector2(34,710),
                     new Pol.Core.Math.Vector2(889,716),
                     new Pol.Core.Math.Vector2(465,670)                                                                
                   ],
    values      : [ 
                    ['🍎','🏰','🗻'] , ['⛵','🍒','🍇'], ['🍉','🍓','🍑'], ['⛄','⏰','⚾'],
                    ['🍍','✈','✉'], ['🍅','🌽','🍓'], ['♠','♥','♣'], ['♦','☕','🔲'],
  ...
  function __initNumbers(numbers){
    ...
    var __getBounds = function(text, size, target){
      ...
      __ctx.save();
      __ctx.lineWidth = 5;
      __ctx.font      = size + 'px Segoe UI Symbol';
    ...
    var __index = Pol.Core.Math.Random(_locations.values.length-1,0)
    var __values = _locations.values[__index];
  ...
  function __drawNumbers(ctx){ 
    ...
    ctx.font        = _FONT_SIZE +'px Segoe UI Symbol';// +'px Moire ExtraBold';
